// let arr=[30,70,43,66,75,65,77,80,34,65];
//  let count=0
...
// let arr=[70,43,66,75,65,77,80,34,65];
// let newar=arr.reduce((res,curr)=>{
//      return res+curr
// })
// console.log(newar)
...
// let mark=[87,90,63,72,90,94,99,67,91,65];
...
//     return (res+curr/arr.length);
// })
// let pro=arr.reduce((cur,res)=>{
//     return res*cur
// })
// console.log(arr);
// console.log(newarr);
...
// document.querySelector('h2').innerHTML=text+"apna collegew"
// let box=document.querySelectorAll('.box')
// box[0].innerHTML="hello1"
// box[1].innerHTML="hello2"
// box[2].innerHTML="hello3"
...
// el.setAttribute('id',"box2")
// let box=document.querySelector('.box11')
// box.append(el)
// box.prepend(el)
// box.after(el)
// box.before(el)
...
// // Data fetch करने के लिए fetch() method का उपयोग
// fetch(apiUrl)
//   .then(response => {
//     if (!response.ok) {
//       throw new Error('Network response was not ok');
//     }
//     return response.json(); // JSON format में data प्राप्त करना
//   })
//   .then(data => {
//     console.log(data); // API से प्राप्त data को console में दिखाना
//   })
//   .catch(error => {
//     console.error('There has been a problem with your fetch operation:', error);
//   });

// API से data fetch करने के लिए async function का उपयोग
...
//           `;
//         });
//         document.querySelector('.div').innerHTML = htmlContent;
//       }, 3000);
  
//       console.log(data);
//     } catch (error) {
//       console.error('Error fetching data:', error);
//       document.querySelector('.div').innerHTML = `<p>Error fetching data. Please try again later.</p>`;
//     }
//   }
...
//         let data= await fetch(`https://www.google.co.in/search?q=${input}`);
